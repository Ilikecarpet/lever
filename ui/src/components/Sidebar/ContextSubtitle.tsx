 ...
 *  here — then that conversation, with the lines Claude Code says it has
 *  changed. A worktree can hold several conversations, so the caller passes
 *  the one in the focused pane. The path stays reachable in the tooltip. */
